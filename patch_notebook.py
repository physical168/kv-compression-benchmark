...
STEP4_NEW = [
    ...
    "\n",
    "RANDOM_SEED = 42\n",
    "MAX_ROWS = 100  # Target count for summary and remaining runs\n",
    "MAX_NEW_TOKENS = 8\n",
    ...
    "]\n",
    "\n",
    "# Reverting to original filename to REUSE existing 1000-row data\n",
    "RUNS_PATH = RUN_DIR / \"finch_4x4_runs.csv\"\n",
    "SUMMARY_PATH = RUN_DIR / \"finch_4x4_summary.csv\"\n",
    "\n",
    "\n",
...
STEP7_NEW = [
    ...
    "    # ── KEY FIX: Strictly take first 100 rows to ensure fair 100-vs-100 comparison ──\n",
    "    part = ok[ok[\"config\"] == cfg].sort_values(\"row_id\").head(MAX_ROWS).copy()\n",
    "    if len(part) == 0:\n",
    "        continue\n",
