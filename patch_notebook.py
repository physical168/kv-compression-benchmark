...
STEP5_NEW = [
    ...
    "# Must be provided; 64 is a safe default for short-to-medium prompts.\n",
    "FINCH_WINDOW_SIZE = 64\n",
    "\n",
    ...
    "    if finch_enabled:\n",
    "        # window_size is required by FinchPress; controls FINCH clustering granularity.\n",
    "        press = FinchPress(compression_ratio=float(compression_ratio), window_size=FINCH_WINDOW_SIZE)\n",
