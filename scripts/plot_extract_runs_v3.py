"""Plot curves from v3/extract_runs.csv.

Run from repo root:
    python scripts/plot_extract_runs_v3.py
"""
...
RUNS = ROOT / "v3" / "extract_runs.csv"
OUT_DIR = ROOT / "figures"
OUT_MEAN_F1 = OUT_DIR / "extract_runs_v3_mean_f1_vs_ratio.png"
OUT_MEAN_ACC = OUT_DIR / "extract_runs_v3_mean_acc_vs_ratio.png"
OUT_BY_QUERY = OUT_DIR / "extract_runs_v3_f1_by_query.png"
...
def main() -> None:
    ...
    line_plot(
        ...
        OUT_MEAN_F1,
        "Extract v3: mean F1 vs compression",
    )
    line_plot(
        "accuracy",
        "mean accuracy (per-query, then average)",
        OUT_MEAN_ACC,
        "Extract v3: mean accuracy vs compression",
    )
    ...
    fig.suptitle("Extract v3: F1 by query", y=1.02)
    fig.tight_layout()
